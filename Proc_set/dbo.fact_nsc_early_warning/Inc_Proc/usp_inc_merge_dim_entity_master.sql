...
/****** Object:  StoredProcedure [dm].[usp_inc_merge_dim_entity_master]    Script Date: 22/07/2021 3:57:38 PM ******/
SET ANSI_NULLS ON
GO
...
/*******************************************
 Name 		: dm.usp_inc_merge_dim_entity_master
 Author     : Shubham Mishra
 Created On : 01, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
CREATE PROCEDURE [dm].[usp_inc_merge_dim_entity_master] (
...
BEGIN
	...
	BEGIN TRY
		MERGE dm.dim_entity_master AS D
		USING dm.view_inc_dim_entity_master AS S
