/*******************************************
 Name 		: dm.usp_merge_dim_nsp_employee
 Author     : Shubham Mishra
 Created On : 17, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
ALTER PROCEDURE dm.usp_merge_dim_nsp_employee (@pipeline_name AS VARCHAR(100) = NULL, @run_id AS VARCHAR(100) = NULL)
AS
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_dim_nsp_employee AS S
...
EXEC dm.usp_merge_dim_nsp_employee;