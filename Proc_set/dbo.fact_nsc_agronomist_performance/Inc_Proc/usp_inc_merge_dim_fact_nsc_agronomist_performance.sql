...
/****** Object:  StoredProcedure [dm].[usp_inc_merge_dim_fact_nsc_agronomist_performance]    Script Date: 22/07/2021 3:59:32 PM ******/
SET ANSI_NULLS ON
GO
...
/*******************************************
 Name 		: dm.usp_inc_merge_dim_fact_nsc_agronomist_performance
 Author     : Shubham Mishra
 Created On : 01, Jul, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
--drop procedure dm.usp_inc_merge_dim_fact_nsc_agronomist_performance
CREATE PROCEDURE [dm].[usp_inc_merge_dim_fact_nsc_agronomist_performance] (
...
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_inc_fact_nsc_agronomist_performance AS S
