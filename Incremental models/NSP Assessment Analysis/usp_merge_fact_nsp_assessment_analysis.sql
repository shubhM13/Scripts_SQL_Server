/*******************************************
 Name 		: dm.usp_merge_fact_nsp_assessment_analysis
 Author     : Shubham Mishra
 Created On : 17, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
CREATE PROCEDURE dm.usp_merge_fact_nsp_assessment_analysis (
...
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_fact_nsp_assessment_analysis AS S
...
EXEC dm.usp_merge_fact_nsp_assessment_analysis;
