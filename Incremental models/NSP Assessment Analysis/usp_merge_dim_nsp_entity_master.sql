/*******************************************
 Name 		: dm.usp_merge_dim_nsp_entity_master
 Author     : Shubham Mishra
 Created On : 17, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
CREATE PROCEDURE dm.usp_merge_dim_nsp_entity_master (
...
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_dim_nsp_entity_master AS S
...
EXEC dm.usp_merge_dim_nsp_entity_master;
