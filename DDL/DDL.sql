...
--2
CREATE TABLE stg.AT_CriteriaCost (
	criteriaId VARCHAR(50) NOT NULL
...
--3
CREATE TABLE stg.AT_CriteriaTip (
	criteriaId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,text NVARCHAR(max)
	,PRIMARY KEY (
...
--4
CREATE TABLE stg.AT_CriteriaToCriteriaGroup (
	criteriaId VARCHAR(50) NOT NULL
...
--5
CREATE TABLE stg.AT_CriteriaToEntityType (
	criteriaId VARCHAR(50) NOT NULL
...
--6
CREATE TABLE stg.AT_CriteriaToTopic (
	criteriaId VARCHAR(50) NOT NULL
...
--7
CREATE TABLE stg.AT_CriteriaToUOM (
	criteriaId VARCHAR(50) NOT NULL
...
--8
CREATE TABLE stg.AT_Criteria_History (
...
--9
CREATE TABLE stg.AT_Criteria_Txt (
	criteriaId VARCHAR(50) NOT NULL
...
--10
CREATE TABLE stg.AT_Criteria_Txt_History (
	auditDate DATETIME2(7) NOT NULL
	,action NVARCHAR(50)
	,auditChangedBy NVARCHAR(50)
	,criteriaId VARCHAR(50) NOT NULL
...
--12
CREATE TABLE stg.AT_Observation_History (
	auditDate DATETIME2(7) NOT NULL
	,action NVARCHAR(50)
	,auditChangedBy NVARCHAR(50)
	,observationId VARCHAR(50) NOT NULL
...
--14
CREATE TABLE stg.AT_Section_Txt (
...
--15
CREATE TABLE stg.AT_SelectedListAnswer (
	observationId VARCHAR(50) NOT NULL
...
--17
CREATE TABLE stg.AT_TemplateToCriteria (
	criteriaId VARCHAR(50) NOT NULL
	,templateId VARCHAR(50) NOT NULL
	,sortOrder FLOAT(53)
...
--18
CREATE TABLE stg.AT_TemplateToCriteriaBranching (
	criteriaId VARCHAR(50) NOT NULL
	,templateId VARCHAR(50) NOT NULL
...
--19
CREATE TABLE stg.AT_TemplateToGeoNode (
	templateId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,PRIMARY KEY (
		templateId
...
--20
CREATE TABLE stg.AT_TemplateToGroup (
	templateId VARCHAR(50) NOT NULL
...
--21
CREATE TABLE stg.AT_TemplateToOrg (
	templateId VARCHAR(50) NOT NULL
...
--22
CREATE TABLE stg.AT_Template_Txt (
	templateId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,title NVARCHAR(255)
	,description NVARCHAR(3000)
...
--23
CREATE TABLE stg.AT_UOMToGeoNode (
	uomSetId NVARCHAR(50) NOT NULL
	,uomItemCode NVARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,PRIMARY KEY (
...
--26
CREATE TABLE stg.CT_Configuration (
...
--28
CREATE TABLE stg.CT_Employee_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,employeeId VARCHAR(50) NOT NULL
...
--30
CREATE TABLE stg.CT_GeoNodeInfo (
	geoNodeId VARCHAR(50) NOT NULL
	,month INT NOT NULL
	,year INT NOT NULL
	,raPercent FLOAT(53)
...
--31
CREATE TABLE stg.CT_GeoNode_Closure (
...
--32
CREATE TABLE stg.CT_GeoNode_Txt (
	geoNodeId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,name NVARCHAR(255) NOT NULL
...
--34
CREATE TABLE stg.CT_KPIDetail_Txt (
	kpiId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,title NVARCHAR(50)
	,PRIMARY KEY (
...
--36
CREATE TABLE stg.CT_ListOptionValidityRule (
	setId VARCHAR(50) NOT NULL
...
--37
CREATE TABLE stg.CT_ListOption_History (
	setId VARCHAR(50) NOT NULL
	,itemCode NVARCHAR(50) NOT NULL
	,parentSetId VARCHAR(50)
	,parentItemCode VARCHAR(50)
...
--39
CREATE TABLE stg.CT_ListOption_Txt_History (
	setId VARCHAR(50) NOT NULL
	,itemCode NVARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,label NVARCHAR(1000) NOT NULL
...
--41
CREATE TABLE stg.CT_ListSet_History (
	setId VARCHAR(50) NOT NULL
	,type NVARCHAR(50) NOT NULL
	,description NVARCHAR(255)
	,status NVARCHAR(50) DEFAULT 'ACTIVE' NOT NULL
...
--42
CREATE TABLE stg.CT_MenuOption (
...
--43
CREATE TABLE stg.CT_MenuOptionToRoles (
	menuId VARCHAR(50) NOT NULL
...
--44
CREATE TABLE stg.CT_MenuOption_Txt (
	menuId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,title NVARCHAR(255)
...
--45
CREATE TABLE stg.CT_NotificationConfig (
...
--46
CREATE TABLE stg.CT_NotificationConfigMailText (
	notificationConfigId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
...
--47
CREATE TABLE stg.CT_NotificationConfigMultiListAnswer (
...
--48
CREATE TABLE stg.CT_NotificationConfigRecipient (
	notificationConfigId VARCHAR(50) NOT NULL
	,employeeId VARCHAR(50) NOT NULL
	,type NVARCHAR(50) NOT NULL
	,PRIMARY KEY (
...
--49
CREATE TABLE stg.CT_NotificationConfigValue (
	configValueId VARCHAR(50) NOT NULL
...
--50
CREATE TABLE stg.CT_NotificationHistory (
...
--51
CREATE TABLE stg.CT_NotificationHistoryMailText (
	notificationId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,subject NVARCHAR(255)
	,body NVARCHAR(1000)
...
--52
CREATE TABLE stg.CT_NotificationHistoryRecipient (
	notificationId VARCHAR(50) NOT NULL
	,employeeId VARCHAR(50) NOT NULL
	,type NVARCHAR(50) NOT NULL
	,isRead TINYINT
...
--53
CREATE TABLE stg.CT_Organisation (
	organisationId VARCHAR(50) NOT NULL
...
--54
CREATE TABLE stg.CT_Organisation_Closure (
	parent VARCHAR(50) NOT NULL
	,child VARCHAR(50) NOT NULL
	,depth INT
	,PRIMARY KEY (
...
--55
CREATE TABLE stg.CT_Organisation_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,organisationId VARCHAR(50) NOT NULL
...
--56
CREATE TABLE stg.CT_OrgToGeoNode (
	organisationId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,PRIMARY KEY (
		organisationId
...
--57
CREATE TABLE stg.CT_PerformanceTgt (
...
--58
CREATE TABLE stg.CT_RuleConfigValue (
...
--59
CREATE TABLE stg.CT_RulesHeader (
...
--60
CREATE TABLE stg.CT_UserKPIControl (
...
--61
CREATE TABLE stg.CT_UserKPIControl_Txt (
	controlId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,label NVARCHAR(255)
...
--62
CREATE TABLE stg.CT_UserKPIDashboard (
	userDashboardId VARCHAR(50) NOT NULL
	,organisationId VARCHAR(50) NOT NULL
...
--63
CREATE TABLE stg.CT_UserSetting (
...
--64
CREATE TABLE stg.CT_UserSetting_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,userName NVARCHAR(50) NOT NULL
...
--65
CREATE TABLE stg.DT_ActionComment_Tracking (
...
--66
CREATE TABLE stg.DT_ActionToTopic_Tracking (
	actionId VARCHAR(50) NOT NULL
	,topicCode NVARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--67
CREATE TABLE stg.DT_Action_Tracking (
	actionId VARCHAR(50) NOT NULL
	,entityId VARCHAR(50)
	,groupId VARCHAR(50)
	,lastModified DATETIME2(7)
...
--68
CREATE TABLE stg.DT_AdhocEvent_Tracking (
...
--69
CREATE TABLE stg.DT_Attachment_Tracking (
...
--70
CREATE TABLE stg.DT_CriteriaTip_Tracking (
	criteriaId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--71
CREATE TABLE stg.DT_CriteriaToCriteriaGroup_Tracking (
	criteriaId VARCHAR(50) NOT NULL
	,groupCode NVARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--72
CREATE TABLE stg.DT_CriteriaToEntityType_Tracking (
	criteriaId VARCHAR(50) NOT NULL
	,entityType NVARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--73
CREATE TABLE stg.DT_CriteriaToTopic_Tracking (
	criteriaId VARCHAR(50) NOT NULL
	,topicCode NVARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--74
CREATE TABLE stg.DT_CriteriaToUOM_Tracking (
	criteriaId VARCHAR(50) NOT NULL
	,uomSetId NVARCHAR(50) NOT NULL
	,uomItemCode NVARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
...
--75
CREATE TABLE stg.DT_Criteria_Tracking (
	criteriaId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
	,PRIMARY KEY (criteriaId)
...
--76
CREATE TABLE stg.DT_Employee_Tracking (
	userName NVARCHAR(50) NOT NULL
	,organisationId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--77
CREATE TABLE stg.DT_EntityToEmployee_Tracking (
...
--78
CREATE TABLE stg.DT_EntityToEntity_Tracking (
	entityId VARCHAR(50) NOT NULL
...
--79
CREATE TABLE stg.DT_Entity_Tracking (
	entityId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--80
CREATE TABLE stg.DT_EventToEmployee_Tracking (
...
--81
CREATE TABLE stg.DT_EventToPerson_Tracking (
	eventId VARCHAR(50) NOT NULL
...
--82
CREATE TABLE stg.DT_Event_Tracking (
	eventId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
	,PRIMARY KEY (eventId)
...
--83
CREATE TABLE stg.DT_GeoNode_Tracking (
	geoNodeId VARCHAR(50) NOT NULL
...
--84
CREATE TABLE stg.DT_GroupToEmployee_Tracking (
	groupId VARCHAR(50) NOT NULL
	,employeeId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--85
CREATE TABLE stg.DT_GroupToEntity_Tracking (
	groupId VARCHAR(50) NOT NULL
	,entityId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--86
CREATE TABLE stg.DT_Group_Tracking (
	groupId VARCHAR(50) NOT NULL
	,organisationId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--87
CREATE TABLE stg.DT_OrgToGeoNode_Tracking (
	organisationId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--88
CREATE TABLE stg.DT_Organisation_Tracking (
	organisationId VARCHAR(50) NOT NULL
	,parentId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--89
CREATE TABLE stg.DT_Person_Tracking (
	personId VARCHAR(50) NOT NULL
	,entityId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--90
CREATE TABLE stg.DT_Plot_Tracking (
...
--91
CREATE TABLE stg.DT_RuleHeader_Tracking (
	ruleId VARCHAR(50) NOT NULL
	,type NVARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--92
CREATE TABLE stg.DT_TemplateToCriteria_Tracking (
	templateId VARCHAR(50) NOT NULL
	,criteriaId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--93
CREATE TABLE stg.DT_TemplateToGeoNode_Tracking (
	templateId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--94
CREATE TABLE stg.DT_TemplateToGroup_Tracking (
	templateId VARCHAR(50) NOT NULL
	,groupId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--95
CREATE TABLE stg.DT_TemplateToOrg_Tracking (
	templateId VARCHAR(50) NOT NULL
	,organisationId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--96
CREATE TABLE stg.DT_Template_Tracking (
	templateId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
	,PRIMARY KEY (templateId)
...
--97
CREATE TABLE stg.DT_UOMToGeoNode_Tracking (
	uomSetId NVARCHAR(50) NOT NULL
	,uomItemCode NVARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
...
--98
CREATE TABLE stg.DT_UserSetting_Tracking (
...
--99
CREATE TABLE stg.DT_VarietyCountryToLOB_Tracking (
...
--100
CREATE TABLE stg.DT_VarietyToEntity_Tracking (
	varietyId VARCHAR(50) NOT NULL
	,entityId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--101
CREATE TABLE stg.DT_VarietyToPlot_Tracking (
	varietyId VARCHAR(50) NOT NULL
	,plotId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--102
CREATE TABLE stg.DT_Variety_Tracking (
	varietyId VARCHAR(50) NOT NULL
	,lastModified DATETIME2(7)
	,status NVARCHAR(50)
...
--103
CREATE TABLE stg.ET_Certification (
...
--104
CREATE TABLE stg.ET_CommodityPrice (
...
--105
CREATE TABLE stg.ET_CommodityTransaction (
...
--108
CREATE TABLE stg.ET_EntityGeoSpatial (
...
--109
CREATE TABLE stg.ET_EntityToEmployee (
	entityId VARCHAR(50) NOT NULL
	,employeeId VARCHAR(50) NOT NULL
...
--110
CREATE TABLE stg.ET_EntityToEntity (
	entityId VARCHAR(50) NOT NULL
	,relatedEntityId VARCHAR(50) NOT NULL
	,relationshipType NVARCHAR(50) NOT NULL
	,PRIMARY KEY (
...
--111
CREATE TABLE stg.ET_EntityToEntity_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,entityId VARCHAR(50) NOT NULL
...
--112
CREATE TABLE stg.ET_Entity_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,entityId VARCHAR(50) NOT NULL
...
--114
CREATE TABLE stg.ET_GroupToEmployee (
	groupId VARCHAR(50) NOT NULL
	,employeeId VARCHAR(50) NOT NULL
	,PRIMARY KEY (
		groupId
...
--115
CREATE TABLE stg.ET_GroupToEntity (
	groupId VARCHAR(50) NOT NULL
	,entityId VARCHAR(50) NOT NULL
	,PRIMARY KEY (
		groupId
...
--116
CREATE TABLE stg.ET_GroupToOrg (
	groupId VARCHAR(50) NOT NULL
	,organisationId VARCHAR(50) NOT NULL
	,PRIMARY KEY (
		groupId
...
--117
CREATE TABLE stg.ET_Group_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,groupId VARCHAR(50) NOT NULL
...
--119
CREATE TABLE stg.ET_Person_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,personId VARCHAR(50) NOT NULL
...
--121
CREATE TABLE stg.ET_Plot_History (
	auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,auditDate DATETIME2(7) NOT NULL
	,plotId VARCHAR(50) NOT NULL
...
--123
CREATE TABLE stg.IT_ActionComment (
	actionId VARCHAR(50) NOT NULL
	,commentId VARCHAR(50) NOT NULL
...
--124
CREATE TABLE stg.IT_ActionToTopic (
	actionId VARCHAR(50) NOT NULL
	,topicCode NVARCHAR(50) NOT NULL
	,PRIMARY KEY (
		actionId
...
--125
CREATE TABLE stg.IT_AdhocEvent (
	adhocEventId VARCHAR(50) NOT NULL
...
--126
CREATE TABLE stg.IT_AdhocEventToTopic (
	adhocEventId VARCHAR(50) NOT NULL
	,topicCode NVARCHAR(50) NOT NULL
	,PRIMARY KEY (
		adhocEventId
...
--128
CREATE TABLE stg.IT_EventToEmployee (
	eventId VARCHAR(50) NOT NULL
	,employeeId VARCHAR(50) NOT NULL
	,PRIMARY KEY (
		eventId
...
--129
CREATE TABLE stg.IT_EventToPerson (
	eventId VARCHAR(50) NOT NULL
	,personId VARCHAR(50) NOT NULL
	,[auditInfo.createdBy] VARCHAR(50)
	,[auditInfo.createdOn] DATETIME2(7)
...
--130
CREATE TABLE stg.IT_EventToTopic (
	eventId VARCHAR(50) NOT NULL
	,topicCode NVARCHAR(50) NOT NULL
	,PRIMARY KEY (
		eventId
...
--132
CREATE TABLE stg.IT_InteractionToTopic (
	interactionId VARCHAR(50) NOT NULL
	,topicCode NVARCHAR(50) NOT NULL
	,PRIMARY KEY (
		interactionId
...
--133
CREATE TABLE stg.IT_Interaction_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,interactionId VARCHAR(50) NOT NULL
...
--134
CREATE TABLE stg.MT_DashboardGeneric (
...
--135
CREATE TABLE stg.MT_DashboardGenericNescafe (
...
--136
CREATE TABLE stg.MT_DashboardGenericYearly (
	lineOfBusiness VARCHAR(50) NOT NULL
	,country VARCHAR(50) NOT NULL
	,cluster VARCHAR(50) NOT NULL
...
--137
CREATE TABLE stg.MT_DashboardTasq (
	lineOfBusiness VARCHAR(50)
	,country VARCHAR(50)
	,cluster VARCHAR(50)
...
--138
CREATE TABLE stg.MT_UOMConversion (
...
--139
CREATE TABLE stg.MT_LassoEntities (
	entityId VARCHAR(50)
	,type VARCHAR(50)
...
--140
CREATE TABLE stg.MT_FarmSummary (
	entityId VARCHAR(50) NOT NULL
...
--141
CREATE TABLE stg.MT_DashboardTasqYearly (
	lineOfBusiness VARCHAR(50)
	,country VARCHAR(50)
	,cluster VARCHAR(50)
	,classification1 VARCHAR(50)
...
--142
CREATE TABLE stg.OT_Allocation (
...
--145
CREATE TABLE stg.OT_NNTracking (
...
--147
CREATE TABLE stg.OT_OmpKPIDefinition (
...
--148
CREATE TABLE stg.OT_OmpKPIDefinition_Txt (
	kpiDefinitionId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,title NVARCHAR(255)
	,PRIMARY KEY (
...
--149
CREATE TABLE stg.OT_OmpKPIFamily (
...
--150
CREATE TABLE stg.OT_OmpKPIFamily_Txt (
	kpiFamilyId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,title NVARCHAR(255)
	,PRIMARY KEY (
...
--151
CREATE TABLE stg.OT_OmpKPIScore (
...
--152
CREATE TABLE stg.OT_OmpKPIScore_Txt (
	kpiScoreId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,title NVARCHAR(255)
	,PRIMARY KEY (
...
--153
CREATE TABLE stg.OT_OmpKPIToMeasurement (
...
--154
CREATE TABLE stg.OT_OmpKPI_Txt (
	kpiId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,title NVARCHAR(255)
...
--155
CREATE TABLE stg.OT_OmpMeasurement (
	kpiMeasurementId VARCHAR(50) NOT NULL
...
--156
CREATE TABLE stg.OT_OmpMeasurement_Txt (
	kpiMeasurementId VARCHAR(50) NOT NULL
	,language NVARCHAR(2) NOT NULL
	,title NVARCHAR(255)
	,PRIMARY KEY (
...
--158
CREATE TABLE stg.OT_OmpPlanReview (
	planId VARCHAR(50) NOT NULL
...
--159
CREATE TABLE stg.OT_OmpPlanReview_History (
...
--160
CREATE TABLE stg.OT_OmpPlanTarget (
	planId VARCHAR(50) NOT NULL
	,kpiId VARCHAR(50) NOT NULL
	,kpiMeasurementId VARCHAR(50) NOT NULL
	,status NVARCHAR(50)
...
--161
CREATE TABLE stg.OT_OmpPlanTarget_History (
	auditDate DATETIME2(7) NOT NULL
	,action NVARCHAR(50)
	,auditChangedBy NVARCHAR(50)
	,planId VARCHAR(50) NOT NULL
...
--162
CREATE TABLE stg.OT_OmpPlanToKPI (
	planId VARCHAR(50) NOT NULL
	,kpiId VARCHAR(50) NOT NULL
...
--163
CREATE TABLE stg.OT_OmpPlanToPeriod (
	planToPeriodId VARCHAR(50) NOT NULL
	,planId VARCHAR(50) NOT NULL
	,planEndDate DATE
...
--164
CREATE TABLE stg.OT_OmpPlanToPeriod_History (
...
--165
CREATE TABLE stg.OT_OmpPlan_History (
...
--167
CREATE TABLE stg.PT_Movement_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,movementId VARCHAR(50) NOT NULL
...
--168
CREATE TABLE stg.PT_NurseryStock (
	entityId VARCHAR(50) NOT NULL
	,varietyId VARCHAR(50) NOT NULL
...
--169
CREATE TABLE stg.PT_NurseryStock_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,entityId VARCHAR(50) NOT NULL
...
--170
CREATE TABLE stg.PT_NurseryToPropMethod (
	entityId VARCHAR(50) NOT NULL
	,varietyId VARCHAR(50) NOT NULL
...
--174
CREATE TABLE stg.PT_VarietyCountryStatus (
	varietyId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
...
--175
CREATE TABLE stg.PT_VarietyCountryToLOB (
	varietyId VARCHAR(50) NOT NULL
	,geoNodeId VARCHAR(50) NOT NULL
	,lineOfBusiness NVARCHAR(50) NOT NULL
	,PRIMARY KEY (
...
--176
CREATE TABLE stg.PT_VarietyResistance (
	varietyId VARCHAR(50) NOT NULL
...
--177
CREATE TABLE stg.PT_VarietyToEntity (
	varietyId VARCHAR(50) NOT NULL
	,entityId VARCHAR(50) NOT NULL
	,percentage FLOAT(53)
	,[auditInfo.createdBy] VARCHAR(50)
...
--178
CREATE TABLE stg.PT_VarietyToEntity_History (
	auditDate DATETIME2(7) NOT NULL
	,auditChangedBy NVARCHAR(50)
	,action NVARCHAR(50)
	,varietyId VARCHAR(50) NOT NULL
...
--179
CREATE TABLE stg.PT_VarietyToParent (
...
--180
CREATE TABLE stg.PT_VarietyToPlot (
	varietyId VARCHAR(50) NOT NULL
	,plotId VARCHAR(50) NOT NULL
	,PRIMARY KEY (
		varietyId
...
--181
CREATE TABLE stg.PT_VarietyToPropMethod (
	varietyId VARCHAR(50) NOT NULL
...
--182
CREATE TABLE stg.PT_VarietyTrial (
...
--183
CREATE TABLE stg.ET_EntityToEmployee_History(
	auditDate DATETIME2(7) NOT NULL,
	auditChangedBy NVARCHAR(50),
	action NVARCHAR(50),
	entityId VARCHAR(50) NOT NULL,
