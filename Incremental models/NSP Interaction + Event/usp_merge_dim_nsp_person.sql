/*******************************************
 Name 		: dm.usp_merge_dim_nsp_person
 Author     : Shubham Mishra
 Created On : 02, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
ALTER PROCEDURE dm.usp_merge_dim_nsp_person (
...
BEGIN
	...
	BEGIN TRY
		MERGE dm.dim_nsp_person AS D
		USING dm.view_dim_nsp_person AS S
...
EXEC dm.usp_merge_dim_nsp_person;
