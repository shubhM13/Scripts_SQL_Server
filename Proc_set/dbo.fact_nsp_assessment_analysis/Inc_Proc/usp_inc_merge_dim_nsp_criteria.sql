...
/****** Object:  StoredProcedure [dm].[usp_inc_merge_dim_nsp_criteria]    Script Date: 22/07/2021 5:03:37 PM ******/
SET ANSI_NULLS ON
GO
...
/*******************************************
 Name 		: dm.usp_inc_merge_dim_nsp_criteria
 Author     : Shubham Mishra
 Created On : 17, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
CREATE PROCEDURE [dm].[usp_inc_merge_dim_nsp_criteria] (
...
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_inc_dim_nsp_criteria AS S
