/*******************************************
 Name 		: dm.usp_merge_fact_nsc_plantlet_assessment
 Author     : Shubham Mishra
 Created On : 09, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
CREATE PROCEDURE dm.usp_merge_fact_nsc_plantlet_assessment (
...
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_fact_nsc_plantlet_assessment AS S
