...
*/
/****** Object:  View [dm].[view_inc_dim_nsp_person]    Script Date: 22/07/2021 6:42:26 AM ******/
SET ANSI_NULLS ON
GO
...
/*******************************************
 ...
 Modified By: Shubham Mishra On 13th May // Event Analysis Nespresso
 *******************************************/
--drop view [dm].[view_inc_dim_nsp_person]
CREATE VIEW [dm].[view_inc_dim_nsp_person]
AS
(
