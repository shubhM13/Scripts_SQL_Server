...
/****** Object:  StoredProcedure [dm].[usp_inc_merge_dim_nsp_organisation]    Script Date: 22/07/2021 5:12:30 PM ******/
SET ANSI_NULLS ON
GO
...
/*******************************************
 Name 		: dm.usp_inc_merge_dim_nsp_organisation
 Author     : Shubham Mishra
 Created On : 17, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
CREATE PROCEDURE [dm].[usp_inc_merge_dim_nsp_organisation] (
...
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_inc_dim_nsp_organisation AS S
