...
/****** Object:  StoredProcedure [dm].[usp_inc_merge_fact_nsc_plantlet_distribution]    Script Date: 22/07/2021 5:21:47 PM ******/
SET ANSI_NULLS ON
GO
...
/*******************************************
Name : dm.usp_inc_merge_fact_nsc_plantlet_distribution
Author : Shubham Mishra
Created On : 08, Jul, 2021
PURPOSE : Data Model Incremental Setup
*******************************************/
--drop procedure dm.usp_inc_merge_fact_nsc_plantlet_distribution
CREATE PROCEDURE [dm].[usp_inc_merge_fact_nsc_plantlet_distribution] (
...
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_inc_fact_nsc_plantlet_distribution AS S
