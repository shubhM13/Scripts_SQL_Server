 ...
 *******************************************/
--drop view dm.view_fact_nsc_4C_analysis
CREATE VIEW dm.view_fact_nsc_4C_analysis
AS
(
...
SELECT *
FROM dm.view_fact_nsc_4C_analysis;

SELECT *
INTO dm.fact_nsc_4C_analysis
FROM dm.view_fact_nsc_4C_analysis;

ALTER TABLE dm.fact_nsc_4C_analysis ADD CONSTRAINT factNsc4C PRIMARY KEY (observationId);