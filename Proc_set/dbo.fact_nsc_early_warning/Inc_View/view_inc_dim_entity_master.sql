...
*/
/****** Object:  View [dm].[view_inc_dim_entity_master]    Script Date: 22/07/2021 2:56:28 AM ******/
SET ANSI_NULLS ON
GO
 ...
 *******************************************/
--DROP VIEW dm.view_inc_dim_entity_master;
CREATE VIEW [dm].[view_inc_dim_entity_master]
AS
(
