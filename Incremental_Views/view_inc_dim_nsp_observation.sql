...
*/
/****** Object:  View [dm].[view_inc_dim_nsp_observation]    Script Date: 22/07/2021 7:14:04 AM ******/
SET ANSI_NULLS ON
GO
...
/*******************************************
 ...
 PURPOSE    : DimObservation for Nespresso Dataset
 *******************************************/
--drop view [dm].[view_inc_dim_nsp_observation]
CREATE VIEW [dm].[view_inc_dim_nsp_observation]
AS
(
		...
		INNER JOIN [dm].[dim_nsp_entity_master] AS H ON A.entityId = H.entityId
			AND A.STATUS = 'ACTIVE'
