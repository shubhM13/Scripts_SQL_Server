/*******************************************
 Name 		: dm.usp_merge_dim_observation
 Author     : Shubham Mishra
 Created On : 30, Jun, 2021
 PURPOSE    : Data Model Incremental Setup
 *******************************************/
--drop procedure dm.usp_merge_dim_observation
CREATE PROCEDURE dm.usp_merge_dim_observation (
...
BEGIN
	...
	BEGIN TRY
		...
		USING dm.view_dim_observation AS S
...
EXEC dm.usp_merge_dim_observation;